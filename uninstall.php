...
/* OBZMOD */
$hmbkp_buwp_installed = false;
$hmbkp_plugins_list = get_plugins();
foreach ($hmbkp_plugins_list as $key => $value) {
	if ( $key == 'backupwordpress/backupwordpress.php' ) $hmbkp_buwp_installed = true;
}
if ( $hmbkp_buwp_installed == false ) 
{
/* OBZMOD */
